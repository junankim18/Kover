...
class Hall(models.Model):
    ...
    hall_lat = models.FloatField(verbose_name='공연장 위도', null=True)
    hall_lng = models.FloatField(verbose_name='공연장 경도', null=True)
...
class Review(models.Model):
    ...
    review_like = models.ManyToManyField(
        Profile, related_name='review_like', verbose_name='리뷰 좋아요 개수', blank=True)
...
class Feed_post(models.Model):
    ...
    feed_like = models.ManyToManyField(
        Profile, related_name='feed_like', blank=True)
